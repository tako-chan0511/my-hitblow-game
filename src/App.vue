...
.show-cands { background: #007bff; color: #fff; }
.show-cands:hover { background: #0056b3; }
.reset, .history-btn { background: var(--primary-color); color: var(--bg-color); }
.vs-history { margin-top: 16px; text-align: center; }
.vs-history .summary { margin-bottom: 8px; font-weight: bold; }
.vs-history table { margin: 0 auto; table-layout: fixed; border-collapse: collapse; font-size: 14px; }
.vs-history th, td { border: 1px solid #ccc; padding: 6px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
